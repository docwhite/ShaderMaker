...
{  
    ...
    float zoo = 0.001 + 0.0008 * sin(0.0001 * pow(120.0, 2.0) * iGlobalTime);
    vec2 cc = vec2(-0.52941,0.526141) + p*zoo;
    vec2 t2c = vec2(cos(iGlobalTime), sin(iGlobalTime));
    vec2 z  = vec2(0.0);
    float trap = 1000.0;
    int iterations = int(100 + int(inputColour.y * 100.0));
